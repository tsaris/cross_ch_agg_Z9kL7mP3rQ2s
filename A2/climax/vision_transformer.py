...
class Block(nn.Module):
    ...
    def __init__(
        ...
        self.attn = Attention(dim, num_heads=num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, proj_drop=drop, tensor_par_size = tensor_par_size, tensor_par_group = tensor_par_group)

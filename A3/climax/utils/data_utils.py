...
DEFAULT_PRESSURE_LEVELS = [10, 20, 30, 50, 70, 100, 150, 200, 250, 300, 400, 500, 600, 700, 850, 925, 1000]
...
for var in ["geopotential", "specific_humidity", "temperature", "u_component_of_wind", "v_component_of_wind"]:
    for lv in DEFAULT_PRESSURE_LEVELS:
        DEFAULT_VARIABLE_LIST.append("_".join((var, str(lv))))

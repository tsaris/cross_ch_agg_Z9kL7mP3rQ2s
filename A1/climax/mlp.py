...
from .dist_functions import F_AllReduce_B_Identity as F_AllReduce_B_Identity
from .dist_functions import F_Identity_B_AllReduce as F_Identity_B_AllReduce

class Mlp(nn.Module):
    """ MLP as used in Vision Transformer, MLP-Mixer and related networks
    """
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, bias=True, drop=0.,tensor_par_size = 1, tensor_par_group = None):
        super().__init__()
        ...
        self.fc1 = nn.Linear(in_features, hidden_features//tensor_par_size, bias=bias[0])
        self.act = act_layer()
        self.drop1 = nn.Dropout(drop_probs[0])
        self.fc2 = nn.Linear(hidden_features//tensor_par_size, out_features, bias=bias[1])
